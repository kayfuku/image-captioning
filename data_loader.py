...
class CoCoDataset(data.Dataset):
    ...
    def get_train_indices(self):
        '''
        Returns a list of indices of length batch_size,
        where each index corresponds to a training image with a caption of length
        randomly sampled from the training set of caption lengths.
        '''
        sel_length = np.random.choice(self.caption_lengths)
        # obtain all image indices that have the selected caption length.
